...
def tkinter_input():
    ...
    def clickMe():
        nonlocal data_type, factor1, archi11, archi20, archi21, archi22, v_path, norm_thres0, norm_thres1, norm_thres2, \
    ...
    win.mainloop()
    return data_type, factor1, archi11, archi20, archi21, archi22, v_path, norm_thres0, norm_thres1, norm_thres2, \
            loss0, loss1, loss2, label_tag0, label_tag1, label_tag2, iso_z_sub_factor, is_denoise, is_sr, is_iso


data_type, factor1, archi11, archi20, archi21, archi22, v_path, norm_thres0, norm_thres1, norm_thres2, loss0, loss1, \
