...
def tkinter_input():
    ...
    def clickMe():
        nonlocal data_type, net_type, factor, archi1, archi2, loss, label_tag, patch_size_d, patch_size_h, patch_size_w,using_lpips
    ...
    win.mainloop()
    return data_type, net_type, factor, archi1, archi2, loss, label_tag, patch_size_d, patch_size_h, patch_size_w,using_lpips


data_type, net_type, factor, archi1, archi2, loss, label_tag, patch_size_d, patch_size_h, patch_size_w, using_lpips = tkinter_input()
...
factor = int(factor)
archi1_ = archi1
archi1 = archi1_ if archi1_ != 'None' else None
archi2 = archi2
loss = loss
...
train_img_size_hr = [factor * h, factor * w, 1] if d == 1 else [factor * d, factor * h, factor * w,
                                                                1]  # [d,h,w] or [h,w]
