...
def RDN3d(lr, factor=4, conv_kernel=3, bn=False, is_train=True, format_out=True, reuse=False, name='RDN'):
    '''Residual Dense net
    Params:
    ...
    with tf.variable_scope(name, reuse=reuse):
        ...
        if format_out:
            if factor == 4:
                ...
                n8 = conv3d(n8, out_channels=G0, filter_size=conv_kernel, name='n8_conv1')
                n8 = conv3d(n8, out_channels=G0, filter_size=conv_kernel, name='n8_conv2')
